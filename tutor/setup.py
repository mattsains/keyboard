...
with open('tutor/__init__.py', 'r') as f:
    for line in f:
...
kwargs = {
    ...
    'author_email': 'matthew@sainsbury.io',
    'maintainer': 'Matthew Sainsbury',
    'maintainer_email': 'matthew@sainsbury.io',
    'url': 'https://github.com/_/tutor',
